            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Silakan tambah absen</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="post" action="../../controller/prosestambah.php">
                        <div class="card-body">
                            <div class="form-group">
                                <label class="form-label">Id</label>
                                <input type="number" class="form-control" required name="id" placeholder="Nama">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="datetime-local" class="form-control" required name="tglk" >
                            </div>
                            <div class="form-group">
                                <label class="form-label">Status</label>
                                <input type="text" class="" required name="buka" >
                            </div>
       </div>
